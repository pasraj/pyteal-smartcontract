...
# Write 
@router.method
def replaceBox(box_name:abi.String, new_box:abi.String):
    return App.box_replace(box_name.get(), Int(0), new_box.get())
...
# Read
@router.method
def exactBox(box_name:abi.String, start:abi.Uint8, end:abi.Uint8, *, output:abi.String):
